        ...
        <div class="row">
            <div class="col col-md-6 col-sm-12 bg-login d-none d-md-block d-lg-block d-xl-block d-xxl-block p-5">
                <div class="p-5 text-white">
                    <h1 class="pb-2 text-6xl">Welcome to <br/>SIS</h1>
                    <h1 class="pb-5 blockquote-footer text-white">Powered by <a href="https://osos.om/solutions.php">OSOS</a>
                    </h1>
                    <p class="pb-5">Our industry-built ERP system is designed for enterprise level architecture for
                        medium and large Companies focused on connecting customers, suppliers, machines and various
                        areas of business operations with the power to support your growth ambitions.</p>
                    <p class="">
                        ...
                        <div id="kc-content">
                            <div id="kc-content-wrapper">
                                ...
                                <#if displayMessage && message?has_content && (message.type != 'warning' || !isAppInitiatedAction??)>
                                    <div class="error-msg alert-${message.type} ${properties.kcAlertClass!} pf-m-<#if message.type = 'error'>danger<#else>${message.type}</#if>">
                                        ...
                                        <label id="templateError"
                                               class="${properties.kcAlertTitleClass!}">${kcSanitize(message.summary)?no_esc}</label>
                                    </div>
                                </#if>
