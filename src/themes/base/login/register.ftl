...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('firstName','lastName','email','username','password','password-confirm'); section>
    <#if section = "header">
        ${msg("registerTitle")}
    <#elseif section = "form">
        <div class="${properties.registerLeftCard!}">
            <div class="${properties.leftCardTopRightVector}">

            </div>
            <div class="${properties.welcomeHeader!}">
                Welcome to
                GEARS SIS
            </div>

            <div class="${properties.welcomeNote!}">
                Our industry-built ERP system is designed for enterprise level architecture for medium and large
                Companies
                focused on connecting customers, suppliers, machines and various areas of business operations with the
                power
                to support your growth ambitions.
            </div>
        </div>
        <div class="${properties.registerRightCard}">
            <div class="${properties.rightHeader}">
                GEARS SIS
            </div>
            <div class="${properties.signUpHeadline}">
                Sign up
            </div>
            <div class="${properties.alreadyHaveAnAccount}">
                Already have an account? <a>Sign in</a>
            </div>
            <form id="kc-register-form" class="${properties.kcFormClass!} ${properties.gearsFormClass!}"
                  action="${url.registrationAction}" method="post" onsubmit=registerOnAdmission("${properties.adminServiceUrl!}","${realm.name!}")>

                <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('nameTitle',properties.kcFormGroupErrorClass!)}">
...
<#--                </div>-->
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="user.attributes.nationality" class="${properties.kcLabelClass!}">${msg("nationality")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="text"
                               ...
                               value="${(register.formData['user.attributes.nationality']!'')}" autocomplete="nationality"
                               aria-invalid="<#if messagesPerField.existsError('nationality')>true</#if>"
                        />
                ...
                <div class="${properties.kcFormGroupClass!} ${messagesPerField.printIfExists('maritalStatus',properties.kcFormGroupErrorClass!)}">
                    <div class="${properties.kcLabelWrapperClass!}">
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="user.attributes.religion" class="${properties.kcLabelClass!}">${msg("religion")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="text" id="user.attributes.religion" class="${properties.kcInputClass!}" name="user.attributes.religion"
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="user.attributes.parentPhone" class="${properties.kcLabelClass!}">${msg("parentPhone")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="text" id="user.attributes.parentPhone" class="${properties.kcInputClass!}" name="user.attributes.parentPhone"
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="user.attributes.parentMobile" class="${properties.kcLabelClass!}">${msg("parentMobile")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="text" id="user.attributes.parentMobile" class="${properties.kcInputClass!}" name="user.attributes.parentMobile"
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="user.attributes.parentEmail" class="${properties.kcLabelClass!}">${msg("parentEmail")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="text" id="user.attributes.parentEmail" class="${properties.kcInputClass!}" name="user.attributes.parentEmail"
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="user.attributes.studentPhoto" class="${properties.kcLabelClass!}">${msg("studentPhoto")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                        <input type="file" id="user.attributes.studentPhoto" class="${properties.kcInputClass!}" name="user.attributes.studentPhoto"
